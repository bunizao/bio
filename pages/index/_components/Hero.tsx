  ...
  return (
    ...
    <span class="text-slate-400/80 text-[0.4em] font-mono italic" lang="en-fonipa" aria-hidden="true">/ˈluːʃən/</span></span>
      ...
      <div class="mt-6">
        ...
        <div class="mt-2">
          <span>✨ Also a <span class="font-mono keyword-box">🎬 Cinephile</span>, <span class="font-mono keyword-box">✍️ Blogger</span> <span class="whitespace-nowrap">and</span> <span class="font-mono keyword-box">📖 Perpetual learner</span><span class="whitespace-nowrap">.</span></span>
        </div>
      </div>
      <Socials />
    </header>
